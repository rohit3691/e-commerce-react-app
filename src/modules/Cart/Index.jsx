...
const [total, setTotal] = useState(0)
  ...
  console.log("carts",Array.isArray(carts))
...
if(carts.length === 0) {
  return <div className=' h-[40vh] flex justify-center items-center text-5xl '>Cart is empty</div>
}
  return (
      ...
      <div className="flex shadow-md my-10">
        ...
        <div id="summary" className="w-1/4 px-8 py-10">
          ...
          <div className="border-t mt-8">
            ...
            <button className="bg-yellow-500 font-semibold hover:bg-indigo-600 py-3 text-sm text-white uppercase w-full">
              Checkout
            </button>
          </div>
        </div>
