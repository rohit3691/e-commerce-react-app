        ...
        <div className="flex flex-wrap md:text-left text-center order-first">
          ...
          <div className="lg:w-1/4 md:w-1/2 w-full px-4">
            ...
            <nav className="list-none mb-10">
              ...
              <li>
                <Link to={"/about"} className="text-gray-600 hover:text-yellow-500">
                  About
                </Link>
              </li>
              <li>
                <Link to={"/contact"} className="text-gray-600 hover:text-yellow-500">
                  Contact
                </Link>
              </li>
            </nav>
          ...
          <div className="lg:w-1/4 md:w-1/2 w-full px-4">
            ...
            <div className="flex xl:flex-nowrap md:flex-nowrap lg:flex-wrap flex-wrap justify-center items-end md:justify-start">
              ...
              <button
                ...
                className="lg:mt-2 xl:mt-0 flex-shrink-0 inline-flex text-white bg-yellow-500 border-0 py-2 px-6 focus:outline-none hover:bg-grey-800 rounded"
              >
                Send
              </button>
            </div>
            <p className="text-gray-500 text-sm mt-2 md:text-left text-center">
              We greatly appreciate your feedback as it
